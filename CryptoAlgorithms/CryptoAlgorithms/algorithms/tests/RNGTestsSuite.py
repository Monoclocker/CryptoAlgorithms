...
class RNGTestSuite(unittest.TestSuite):
    def __init__(self):
        super(RNGTestSuite, self).__init__([
            ...
            Parameter_a_ShouldBeLowerThen_m_Constant(),
...
class Parameter_a_ShouldBeLowerThen_m_Constant(unittest.TestCase):
    def runTest(self):
        rng = RNG()
        self.assertLess(rng.a, m)

class Parameter_b_ShouldBeLowerThan_m_Constant(unittest.TestCase):
    def runTest(self):
        rng = RNG()
        self.assertLess(rng.b, m)

class Parameter_c0_ShouldBeLowerThan_m_Constant(unittest.TestCase):
    def runTest(self):
        rng = RNG()
        self.assertLess(rng.c_0, m)